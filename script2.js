...
RMEnhancedModel = require('a96fc/ff0b8/e72a9').extend({
    ...
    initCSS: function() {
		$(".background").find('img').attr('src','http://i.imgur.com/xcPLupP.png');
		...
		$('#room').append('<div class="is-leave" style="margin-top: 300px; text-align: center;"><a href="https://www.facebook.com/groups/547885508611462/" target="_blank"><img src="http://i.imgur.com/eoeofSU.png"></a></div>');
