...
RMEnhancedModel = require('f5884/a365f/b5948').extend({
    ...
    initCSS: function() {
                ...
                $(".background").find('img').attr('src','http://i.imgur.com/dcs8bFo.png');
        $('head').append('<link rel="stylesheet" type="text/css" href="https://dl.dropboxusercontent.com/s/xrc8z5doey7y4zc/style.css">');
                ...
                $('#room').append('<div class="is-leave" style="margin-top: 100px; text-align: center;"><a href=""><img src="http://i.imgur.com/VdlgFSU.png"></a></div>');
