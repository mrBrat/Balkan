...
RMEnhancedModel = require('ac785/bc190/b96e1').extend({
    ...
    initCSS: function() {
        ...
        $('head').append('<link rel="stylesheet" type="text/css" href="https://raw.github.com/nihad08/Balkan/master/balkan3.js">');
		...
		$('#dj-booth').append('<div id="rmbooth" style="background-image: url(https://raw.github.com/nihad08/Balkan/master/balkan3.js);"></div>');
