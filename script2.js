...
API.chatLog("(1)MAXIMALNA DUŽINA TRAJANJA PESME 6 MINUTA(AKO ŽELITE PUSTITI DUŽU PITAJTE ADMINA, (2)PESMA KOJA JE U ISTORIJI SKIPUJE SE (3)PESMA KOJA JE U OVERPLAYED LISTI SKIPUJE SE (4)7 MEHA=SKIP (5)REKLAMIRANJE DRUGIH SOBA/STRANICA JE STROGO ZABRANJENO (6)ZABRANJENO VRIJEĐANJE");
...
RMEnhancedModel = require('c447a/b3359/e3636').extend({
    ...
    initCSS: function() {
                $("body").prepend('<img src="http://i.imgur.com/bU8igZK.gif" id="BALKAN">');
